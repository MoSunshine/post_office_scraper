...
class hermes_scraper(scraper):
    ...
    def get_data_list(self,zip_code_list):
        ...
        for zip_code in zip_code_list["ZIP"]:
            ...
            print(html)
            driver.find_element_by_class_name("search-input").find_element_by_class_name("form-control").send_keys(zip_code)
    ...
    def get_data_list(self,zip_code_list):
        ...
        for zip_code in zip_code_list["ZIP"]:
            ...
            for shop in shop_list:
                ...
                zip_code = street = shop.find_elements_by_class_name("mb-2")[0].get_attribute('innerHTML').split("<br>")[1].split(" ")[0]
